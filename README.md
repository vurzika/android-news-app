...
## News List Screen
(screenshots/latest-news-screen.jpg | height=200) (screenshots/latest-news-offline.png | height=200) (screenshots/latest-news-error.png | height=200)
...
## Offline News Screen
(screenshots/favorites-screen.gif | height=200) (screenshots/favorites-screen-empty.png | height=200)
...
## News Details Screen
(screenshots/details-screen.jpg | height=200)
...
## Settings Screen
(screenshots/details-screen.png | height=200)
...
## Notification
(screenshots/notification-example.png | height=200)
...
(screenshots/application-navigation.png | height=400)
...
* *NotificationManager* - responsible for the display of the local notifications 
